...
class Undur_diri extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->model = $this->Undur_diriModel;
    }
    ...
    public function index()
    {
        ...
        $this->template->title('Undur Diri List');
        $this->setTitlePage();
    ...
    public function get_list()
    {
        ...
        $url_delete = "'" . base_url("undur_diri/delete") . "'";
        $data = array();
        $no = $_POST['start'];
        foreach ($all_data as $key => $val) {
            ...
            $no++;
            $row = array();
            $row[] = '<button type="button" onclick="action_undur_diri(\'' . $val->nisn . '\',8)" class="btn btn-danger btn-sm">Batalkan</button>';
            $row[] = $val->nisn;
            $row[] = $val->no_wa;
    ...
    {
        $prosess = $this->model->get_peserta_undur_diri($nisn);
        echo $prosess;
    }

    public function aksi_undur_diri()
    {
        $prosess = $this->model->aksi_undur_diri($_POST['nisn'], $_POST['status']);
        echo $prosess;
    }
}
