...
class WaitingModel extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT * FROM ms_artikel WHERE active = 1 ORDER BY created_time DESC LIMIT 4");
    ...
    public function getArticleDetail($post)
    {
        ...
        $res = $query->row();
        return json_encode(['error' => false, 'msg' => 'Success update data', 'data' => $res]);
    }
}
