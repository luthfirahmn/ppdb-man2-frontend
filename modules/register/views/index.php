...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo FT_APP_ASSETS ?>css/plugins/extensions/ext-component-sweet-alerts.css">
    <!-- END: Page CSS-->
                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-register-form mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="nisn" name="nisn" aria-describedby="nisn" tabindex="1" autofocus />
                                    </div>
                                    <div class="form-group">
                                        <label for="nama_lengkap" class="form-label">Nama Lengkap</label>
                                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" aria-describedby="nama_lengkap" tabindex="1" autofocus />
                                    </div>
                                    <div class="form-group">
                                        <label for="tgl_lahir" class="form-label">Tanggal Lahir</label>
                                        <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" min="2002-01-01" max="2011-12-31" aria-describedby="tgl_lahir" tabindex="1" autofocus />
                                    </div>

                                    <div class="form-group">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="text" class="form-control" id="email" name="email" aria-describedby="register-email" tabindex="2" autocomplete="off" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="no_wa" name="no_wa" aria-describedby="basic-addon3" placeholder="Contoh : 81312xxxx56" />
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="check_alur" name="check_alur" tabindex="4" />
