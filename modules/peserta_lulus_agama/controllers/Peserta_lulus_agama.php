...
class Peserta_lulus_agama extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->model = $this->Peserta_lulus_agamaModel;
    }
    ...
    public function index()
    {
        ...
        $this->template->title('Peserta Lulus Agama List');
        $this->setTitlePage();
    ...
    public function get_list()
    {
        ...
        $url_delete = "'" . base_url("agama/delete") . "'";
        $data = array();
        $no = $_POST['start'];
        foreach ($all_data as $key => $val) {
            ...
            $row[] =
                ...
                '<a href="' . BASE_URL . 'peserta_lulus_agama/download_berkas/' . $val->id . '" class="btn btn-primary btn-sm" style="width:40px"><i class="fa fa-download"></i></a>';
            // $row[] = '';
            $row[] = $val->nisn;
            $row[] = $val->no_wa;
