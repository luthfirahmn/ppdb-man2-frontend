...
class Peserta_ppt extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->model = $this->Peserta_pptModel;
    }
    ...
    public function index()
    {
        ...
        $this->template->title('Peserta PPT List');
        $this->setTitlePage();
    ...
    public function get_list()
    {
        ...
        foreach ($all_data as $key => $val) {
            ...
            $row[] =
                ...
                '<a href="' . BASE_URL . 'peserta_ppt/download_berkas/' . $val->id . '" class="btn btn-primary btn-sm" style="width:40px"><i class="fa fa-download"></i></a>';
            $row[] = $val->nisn;
            $row[] = $val->no_wa;
