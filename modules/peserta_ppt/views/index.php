            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float-right">Download Data<br><a href="<?php echo base_url('peserta_ppt/export_data/4') ?>" class="btn btn-primary"> <i class="fa fa-download"></i> Download Data</a></span>
