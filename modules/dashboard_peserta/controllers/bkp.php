...
class Dashboard_peserta extends FT_Controller
{
    ...
    public function index()
    {
        ...
        $query = $this->db->query("SELECT s.nisn,s.nama_lengkap,i.waktu,i.tanggal,i.ruangan FROM ms_jadwal_btq i LEFT JOIN ms_siswa s ON s.id = i.id_siswa WHERE s.id = '{$id}'");
        $result = $query->num_rows();

        // $query = $this->db->query("SELECT id_status,pengumuman,s.info,status_berkas,informasi_peserta FROM ms_siswa i JOIN ms_status s ON s.status = i.id_status LEFT JOIN ms_jalur j ON j.id = i.id_jalur  WHERE i.id = '{$id}'");
        ...
        $query = $this->db->query("SELECT
                                        ...
                                        s.*
                                    FROM ms_siswa i
                                    JOIN tr_status s ON s.status = i.id_status
        ...
        // $script["js"] = [
        //     FT_APP_ASSETS . "vendors/js/charts/apexcharts.min.js",
        //     FT_APP_ASSETS . "js/scripts/pages/dashboard-ecommerce.js",
        // ];
