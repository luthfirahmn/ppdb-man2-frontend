...
class Peserta_keagamaanModel extends MY_Model
{
...
");
    ...
    public function get_alamat($id)
    {
        $query = $this->db->query("SELECT *
                                    ...
                                    WHERE table1.id_siswa IN (SELECT id FROM ms_siswa WHERE id_jalur = {$id} AND id_status != 0)
