...
class Peserta_keagamaan extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->model = $this->Peserta_keagamaanModel;
    }
    ...
    public function index()
    {
        ...
        $this->template->title('Peserta Keagamaan List');
        $this->setTitlePage();
    ...
    public function get_list()
    {
        ...
        foreach ($all_data as $key => $val) {
            ...
            $row[] =
                ...
                '<a href="' . BASE_URL . 'peserta_keagamaan/download_berkas/' . $val->id . '" class="btn btn-primary btn-sm" style="width:40px"><i class="fa fa-download"></i></a>';
            $row[] = $val->nisn;
            $row[] = $val->no_wa;
