...
class Peserta_lulus_akademik extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->model = $this->Peserta_lulus_akademikModel;
    }
    ...
    public function index()
    {
        ...
        $this->template->title('Peserta Lulus Akademik List');
        $this->setTitlePage();
    ...
    public function get_list()
    {
        ...
        foreach ($all_data as $key => $val) {
            ...
            $row[] =
                ...
                '<a href="' . BASE_URL . 'peserta_lulus_akademik/download_berkas/' . $val->id . '" class="btn btn-primary btn-sm" style="width:40px"><i class="fa fa-download"></i></a>';
            // $row[] = '';
            $row[] = $val->nisn;
            $row[] = $val->no_wa;
    ...
    //     // pre($res);
    //     if (!$res) {
    //         redirect('peserta_lulus_akademik');
    //         die;
    //     }
    //     $files = array(
