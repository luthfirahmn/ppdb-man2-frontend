            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <span class="float-left ">Download Template<br><a href="<?php echo base_url('penilaian_non_akademik/download_template') ?>" class="btn btn-primary"> <i class="fa fa-download"></i> Download Template</a></span>
                    </div>
                </div>
            </div>
            <div class="col-6">
