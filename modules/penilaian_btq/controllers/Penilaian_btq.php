...
class Penilaian_btq extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->model = $this->Penilaian_btqModel;
    }
    ...
    public function index()
    {
        ...
        $this->template->title('Penialain BTQ List');
        $this->setTitlePage();
    ...
    public function get_list()
    {
        ...
        foreach ($all_data as $key => $val) {
            $no++;
            $row = array();
            // $row[] = buttons("edit", "location.href='" . base_url("/Penilaian_btq/form_edit/" . $val->id . "") . "'") . ' ' . buttons("delete", "myDelete($val->id, $url_delete)");
            $row[] = $no;
            $row[] = $val->nisn;
            $row[] = $val->no_wa;
    ...
    public function download_template()
    {
        ...
        // Rename worksheet
        $spreadsheet->getActiveSheet()->setTitle('PENILAIAN BTQ');
        ...
        header('Content-Disposition: attachment;filename="PENILAIAN BTQ.xlsx"');
    ...
    public function penilaian()
    {
        ...
        $query = $this->db->query("SELECT * FROM tr_penilaian WHERE Type = 'BTQ' ORDER BY id ASC");
        $result = $query->result();
