...
<body class="bg-white">
    <div class="bg-white text-gray-800  shadow-lg overflow-hidden relative flex w-full starring ">
        <div
            class="shadow-xl mb-3 absolute top-0 bg-gradient-to-b from-cyan-500 to-cyan-400 w-full z-10 flex px-5 py-2 text-center items-center">
        ...
        <div class="bg-white h-full w-full px-2 lg:px-10 pt-20 pb-20 overflow-y-auto">
            ...
            <div class="mb-5" id="pendaftaran">
                <div class="block rounded-lg relative p-5 transform transition-all duration-300 scale-100 hover:scale-95 shadow-xl"
                    style="background: url(<?= ASSETS . 'images/bg.png' ?>) center; background-size: cover;">
                    <div class="absolute top-0 left-3 -mt-3 mr-3 ">
                        <div class="rounded-full bg-cyan-500 text-white text-xs py-1 pl-2 pr-3 leading-none shadow"><i
                                class="mdi mdi-fire text-base align-middle"></i> <span class="align-middle">Pendaftaran
            ...
            <div class="lg:flex mb-5 lg:space-x-3" id="agenda">
                <!-- Card 1 -->
                <div
                    class="rounded-lg block w-full h-full transition-all duration-300 transform scale-100 hover:scale-105">
                    <div class="bg-white p-4 rounded-lg shadow-xl relative">
                        <h2
                            class="text-xl text-center font-bold mb-2 text-white py-2 relative overflow-hidden bg-gradient-to-r from-white via-cyan-500 to-white absolute inset-0">
                            Agenda PPDB
                        </h2>
                        <div class="w-full mt-4 relative aspect-w-16 aspect-h-9">
                            ...
                            <img class="w-full h-full object-cover opacity-0"
                                src="<?= ASSETS . 'images/agenda_jalur-1.png' ?>" alt="Agenda Jalur 1"
                ...
                <div
                    ...
                    <div class="bg-white p-4 rounded-lg relative">
                        ...
                        <div class="w-full mt-4 relative aspect-w-16 aspect-h-9">
                            ...
                            <img class="w-full h-full object-cover opacity-0" src="<?= ASSETS . 'images/alur-1.png' ?>"
                                alt="Alur 1" onload="this.classList.add('opacity-100');">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <a href="#" class="flex w-full transform transition-all duration-300 scale-100 hover:scale-95"
                    onclick="articleDetail(<?= $row->id ?>)">
                    <div class=" block h-24 w-[25%] lg:w-[10%] rounded overflow-hidden"
                        style="background: url(<?= ASSETS . 'images/alur-1.png' ?>) center; background-size: cover;">
                    </div>
                    <div class="pl-3 w-[75%]">
        ...
        <div
            class="bg-gradient-to-b from-cyan-500 to-cyan-400 absolute bottom-0 w-full border-t border-gray-200 flex text-white  hover:text-indigo-100">
