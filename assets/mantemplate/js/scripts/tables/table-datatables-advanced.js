  ...
  if (dt_ajax_table.length) {
    var dt_ajax = dt_ajax_table.dataTable({
      ...
      buttons: [
        {
          text: ' PDF',
          className: 'btn btn-icon btn-secondary buttons-pdf ml-2',
          extend: 'pdfHtml5',
          exportOptions: {
            columns: ':visible'
          }
        ...
        {
          text: ' Copy',
          className: 'btn btn-icon btn-secondary buttons-copy',
          extend: 'copyHtml5',
          exportOptions: {
            columns: ':visible'
          }
        ...
        {
          extend: 'excelHtml5',
          className: 'btn btn-icon btn-secondary buttons-excel',
          exportOptions: {
            columns: ':visible'
          }
        },
        {
          extend: 'csvHtml5',
          className: 'btn btn-icon btn-secondary buttons-csv',
          exportOptions: {
            columns: ':visible'
          }
        },
