...
<body>
    <div style="text-align:center">
        ...
        <div>
            ...
            <p>Berdasarkan Hasil Penilaian secara Akademik Penerimaan Peserta Didik Baru (PPDB)
        ...
        <p>Menjadi Calon Peserta Didik Baru kelas X ( Sepuluh )
            Madrasah Aliyah Negeri 2 Kota Bandung Tahun Pelajaran 2024-2025
            <b> MELALUI ' . strtoupper($all_data->jalur) . ' </b>
        </p>';

            echo ' <p style="text-align: left;"><b>Catatan : </b><br>
            Silahkan anda melakukan DAFTAR ULANG dengan membawa berkas yang diperlukan,
            pada hari Kamis s/d Sabtu, 06 s/d 8 Juni 2024 Pukul 08.00 s/d 14.00 WIB bertempat di
            Gedung Serba Guna MAN 2 Kota Bandung. <br> <br>
            ...
            8. Membawa materai Rp.10.000,- (1 lembar) <br>
            ...
            echo ' <p>
            Mohon maaf, anda dinyatakan <b>TIDAK LULUS</b> dalam PPDB MAN 2 Kota Bandung jalur akademik,
            <br>

           <ul>
           <li style="text-align: left;">
           Ananda mendapat kesempatan masuk <b>TANPA SELEKSI</b> di SMK Muhammadiyah 2 Cibiru, Kota Bandung di Jalan Cilengkrang II No.7. No. Kontak
            089669907509 (Akbar Rosmanda)
           </li>
           </ul>
        </p>';
        }
