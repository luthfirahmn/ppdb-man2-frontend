    ...
    <center>
        ...
        <table style="width: 700px;">
            <tr>
                ...
                <td class="text" align="center">Bandung, 19 Mei 2023 <br>Ketua PPDB<br><br>TTD<br><br>Enjang Bakar,
                    S.pd</td>
            </tr>
        </table>
        <table width="625">
